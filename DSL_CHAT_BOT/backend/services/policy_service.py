...
class PolicyService:
    ...
    def llm_answer_with_policy(self, question):
        ...
        prompt = (
            ...
            "[답변 구조]\\n"
            "(상황공감과 개요안내는 제목을 제외하고 내용만 제공할것\n)"
            "상황 공감: 사용자 질문에 맞는 공감 멘트 (예: '창업을 준비중이시군요!')\\n"
            "개요 안내: '창업을 위한 다양한 지원사업이 있습니다. 현재 이용 가능한 정책을 중심으로 안내해 드리겠습니다.'\\n\\n"
            
            "🔍상세 정책 설명: 각 정책을 자연스럽게 연결하여 설명\\n"
